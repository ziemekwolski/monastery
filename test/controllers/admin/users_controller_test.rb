...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { email: @admin_user.email, linkedin: @admin_user.linkedin, name: @admin_user.name, password: @admin_user.password, twitter: @admin_user.twitter }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { email: @admin_user.email, linkedin: @admin_user.linkedin, name: @admin_user.name, password: @admin_user.password, twitter: @admin_user.twitter }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
